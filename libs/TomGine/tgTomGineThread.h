...
//  TomGine::tgCamera m_tgCamera;
  ...
  // ------------ thread locks ------------
  tgThread thread_gl; // tomGine thread_gl
  //tgThread thread_event; // thread for event handling (keyboard, mouse, resize, etc ...)
  tgMutex dataMutex; // mutex for data
  tgMutex eventMutex; // mutex for data
  //tgSemaphore renderSem;
  tgSemaphore renderFinishedSem;
  tgSemaphore clearFinishedSem;
  tgSemaphore snapshotSem;
